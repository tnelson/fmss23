/*
  FMSS23 Lab 2 (Lock 2b)

  Dev note: this model allows processes to remain disinterested forever
    revealing the *livelock* bug in this algorithm. Note again that
    the problem wasn't "oops I made a typo or misunderstood an Alloy 
    operator", but rather "oops, I didn't think of something important
    in the real world!"

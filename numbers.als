...
pred BSpeaks {
	...
	BSpoke.possibleFrom = Start.possibleFrom & {w: World, p: Person, w2: World | 
		numberAdjacent[w, B] = numberAdjacent[w2, B]
    }
}
pred CSpeaks {
    -- say nothing in 2nd round
...
run {baseKnowledge and BSpeaks and CSpeaks} for exactly 3 State, exactly 7 Card, exactly 140 World
